...
Условный захват возникает, когда спутник выше маски, контроллер исправен и ошибка
не превышает 0,5° непрерывно в течение двух модельных секунд. Тогда счётчик учебных
пакетов увеличивается на 10 в секунду. Эти пакеты — числа в памяти, без содержания и сетевого обмена.
В исходной модели этот критерий характеризует геометрическое наведение, а не энергетический запас канала.
...
Точность реальной связи, характеристики оборудования и энергетика требуют отдельного моделирования».
